  ...
  const std::string json = R"EOF(
{
  ...
  TableMetadataV2 metadata = MakeMetadata(json);
  EXPECT_EQ(metadata.GetLocation(), "./lineitem_iceberg");
  EXPECT_EQ(metadata.GetTableUUID(), "a319422b-6f8c-44d0-90ba-96242d9a1d7b");
}
