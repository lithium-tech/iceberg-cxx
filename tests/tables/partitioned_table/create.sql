...
CREATE TABLE warehouse.example_schema.partitioned_table (c1 INTEGER, c2 DATE, c3 DOUBLE) WITH (
    format = 'PARQUET',
    partitioning = ARRAY ['c1', 'c2'],
    location = 's3a://warehouse/partitioned_table'
);

INSERT INTO
    warehouse.example_schema.partitioned_table
VALUES
