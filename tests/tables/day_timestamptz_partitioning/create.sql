...
CREATE TABLE warehouse.example_schema.day_timestamptz_partitioning (c1 INTEGER, c2 TIMESTAMP(6) WITH TIME ZONE, c3 DOUBLE) WITH (
    format = 'PARQUET',
    partitioning = ARRAY ['day(c2)'],
    location = 's3a://warehouse/day_timestamptz_partitioning'
);

INSERT INTO
    warehouse.example_schema.day_timestamptz_partitioning
VALUES
